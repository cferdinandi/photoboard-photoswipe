...
/**
 * Plugin Name: Photoboard PhotoSwipe
 ...
 */
	 ...
	 */
	function photoboard_photoswipe_gallery( $output, $attr ) {
	...
	add_filter( 'post_gallery', 'photoboard_photoswipe_gallery', 10, 2 );
	 ...
	 */
	function photoboard_photoswipe_styles_and_scripts() {
		global $post;
